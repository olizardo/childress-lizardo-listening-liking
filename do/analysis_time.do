...
*Do race coded listening vs. liking gaps
*do it both ways where pop is white (6=white) and pop is excluded

****NO POP FIRST
egen like_expop_white = rowmean( ///
    like_music_genres_21 /// 1 Big band
    like_music_genres_22 /// 2 Bluegrass
    like_music_genres_24 /// 4 Classic rock
    like_music_genres_25 /// 5 Classical
    like_music_genres_27 /// 7 Alt/rock/punk
    like_music_genres_28 /// 8 Country
    like_music_genres_29 /// 9 Easy listening
    like_music_genres_30 /// 10 Folk
    like_music_genres_32 /// 12 Heavy metal
    like_music_genres_35 /// 15 Musicals
    like_music_genres_36 /// 16 New age
    like_music_genres_37 /// 17 Oldies
    like_music_genres_38 /// 18 Opera
)

egen like_expop_nonwhite = rowmean( ///
    like_music_genres_23 /// 3 Blues/R&B
    like_music_genres_31 /// 11 Gospel
    like_music_genres_33 /// 13 Jazz
    like_music_genres_34 /// 14 Latin/salsa
    like_music_genres_39 /// 19 Rap/hip hop
    like_music_genres_40 /// 20 Reggae
)
...
egen like_incpop_white = rowmean( ///
    like_music_genres_21 /// 1
    like_music_genres_22 /// 2
    like_music_genres_24 /// 4
    like_music_genres_25 /// 5
    like_music_genres_26 /// 6 POP
    like_music_genres_27 /// 7
    like_music_genres_28 /// 8
    like_music_genres_29 /// 9
    like_music_genres_30 /// 10
    like_music_genres_32 /// 12
    like_music_genres_35 /// 15
    like_music_genres_36 /// 16
    like_music_genres_37 /// 17
    like_music_genres_38 /// 18
)
...
****High vs. low gap (liking stuff you're not listening to)
...
* Mapping: like_music_genres_21..40 -> genres 1..20
*-----------------------------
forvalues g = 1/20 {
    local v = 20 + `g'
    gen like_g`g' = inrange(like_music_genres_`v', 5, 7)
...
*-----------------------------
* Recreate genre-level overclaim data
*-----------------------------
preserve
...
***Although many respondents report liking a wide range of genres, those who fail to enact this breadth in their listening behavior are especially likely to listen to less consecrated music. see this one: 
regress composition_listen_ten gap_volume_listen_like educ2 child_arts agecat income female urban_rural2  i.race5,  vce(robust)
...
regress composition_listen_ten mu_hb_lb_genrecount_diff educ2 child_arts agecat income female urban_rural2  i.race5,  vce(robust)
