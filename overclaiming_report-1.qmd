...
ggplot(df_active, aes(x = prop, y = genre_name, fill = engagement_state)) +
...
- **Highly Underclaimed**: While no genre is dominated primarily by underclaiming, Contemporary Pop has the highest absolute rate of "Listen Only", meaning many people listen to it heavily without bothering to rate it highly on the survey.
...
ggplot(pred_df_rob, aes(x = child_arts, y = estimate, color = response.level)) +
