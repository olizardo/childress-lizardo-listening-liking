...
format_gt_table(df_overclaim, "**Predictors of Overclaiming (Like Only)**")
```
...
format_gt_table(df_underclaim, "**Predictors of Underclaiming (Listen Only)**")
```
...
format_gt_table(df_true, "**Predictors of True Engagement (Like and Listen)**")
```
